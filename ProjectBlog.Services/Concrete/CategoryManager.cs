...
namespace ProjectBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public CategoryManager(IUnitOfWork unitOfWork, Mapper mapper)
        {
        ...
        public async Task<IDataResult<CategoryDto>> Get(int categoryId)
        {
            ...
            return new DataResult<CategoryDto>(ResultStatus.Error, "Boyle bir kategori bulunanadi", null);
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAll()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Error, "Kategori hic bulunamadi", null); 
        }
        ...
        public async Task<IResult> Update(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            await _unitOfWork.Categories.UpdadeAsync(category).ContinueWith(t => _unitOfWork.SaveAsync());
        ...
        public async Task<IResult> Delete(int categoryId, string modifiedByName)
        {
            ...
            return new Result(ResultStatus.Error, "Boyle bir kategori bulunanadi");
        }
